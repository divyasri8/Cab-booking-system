...
public:
    ...
    {
        ifstream in("old-customers(student).txt");
        {
            if(!in)
            {
...
public:
    ...
    void printBill()
    {
        ofstream outf("receipt.txt"); //receipt for bought items
        {
            ...
            outf << "Customer ID: " << Customer::studentID << endl << endl;
